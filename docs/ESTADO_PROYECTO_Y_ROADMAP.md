...
# ==========================================
# 6. STRIPE (PLANES Y SUSCRIPCIONES — free | pro | agro)
# ==========================================
...
STRIPE_SUCCESS_URL=https://tu-frontend/planes?status=success
STRIPE_CANCEL_URL=https://tu-frontend/planes?status=cancel
