...
9. **Suscripciones (2 planes):** Modelo freemium con **Gratis** (con anuncios) y **Pro** ($10/mes, sin anuncios) para sufragar la publicidad de la web. Incluye ONVO Pay (cargos recurrentes con SDK web embebido), webhooks idempotentes y límites mensuales por plan.
