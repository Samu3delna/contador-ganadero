...
9. **Suscripciones (3 planes):** Modelo freemium con **Gratis** (con anuncios), **Pro** y **Agro** (sin anuncios) para sufragar la publicidad de la web. Incluye ONVO Pay (cargos recurrentes con SDK web embebido), webhooks idempotentes y límites mensuales por plan.
