...
export default function DeclaracionesPage() {
  ...
  const cargarDatos = useCallback(async () => {
    setCargando(true);
    try {
      const [cfg, res, gst, ing] = await Promise.all([
        obtenerConfigFiscalAPI(),
  ...
  const guardarIngreso = async () => {
    try {
      const payload = {
        ...
        montoSubtotal: 0, // se calcula en el backend
        comprador: {
        ...
        <>
              ...
              <div className="glass-card" style={{ marginBottom: 'var(--espacio-lg)' }}>
                ...
                <div className="declaracion-grid-3" style={{ marginTop: 'var(--espacio-md)' }}>
                  ...
                  <div className="form-group">
                    ...
                    <select
                      className="input"
                      value={nuevoIngreso.categoriaIngreso}
                      onChange={(e) => setNuevoIngreso({ ...nuevoIngreso, categoriaIngreso: e.target.value })}
                    >
                      <option value="venta_ganado_pie">Venta de Ganado en Pie</option>
                      <option value="venta_leche">Venta de Leche</option>
                      <option value="otros_ingresos">Otros Ingresos (paja, estiércol, alquiler)</option>
                    </select>
                  </div>
                  <div className="form-group">
                    ...
                    <select
                      className="input"
                      value={nuevoIngreso.tasaIVA}
                      onChange={(e) => setNuevoIngreso({ ...nuevoIngreso, tasaIVA: e.target.value })}
                    >
                      <option value={0}>0% (Exento)</option>
                      <option value={1}>1% (Canasta Básica/Agropecuaria)</option>
                  ...
                  {nuevoIngreso.categoriaIngreso === 'venta_ganado_pie' && (
                    <>
                      <div className="form-group">
                        ...
                        <select
                          className="input"
                          value={nuevoIngreso.tipoGanado}
                          onChange={(e) => setNuevoIngreso({ ...nuevoIngreso, tipoGanado: e.target.value })}
                        >
                      ...
                      <div className="form-group">
                        ...
                        <input
                          ...
                          type="number"
                          min="0"
                          value={nuevoIngreso.cantidadCabezas}
                          onChange={(e) => setNuevoIngreso({ ...nuevoIngreso, cantidadCabezas: e.target.value })}
                        />
                      </div>
                      <div className="form-group">
                        ...
                        <input
                          ...
                          value={nuevoIngreso.pesoTotal}
                          onChange={(e) => setNuevoIngreso({ ...nuevoIngreso, pesoTotal: e.target.value })}
                        />
                      </div>
                      <div className="form-group">
                        ...
                        <input
                          ...
                          min="0"
                          placeholder="Opcional"
                          value={nuevoIngreso.precioPorKilo}
                          onChange={(e) => setNuevoIngreso({ ...nuevoIngreso, precioPorKilo: e.target.value })}
                        />
                      </div>
                      <div className="form-group">
                        <label>Precio Unitario (por cabeza)</label>
                        <input
                          className="input"
                          type="number"
                          min="0"
                          value={nuevoIngreso.precioUnitario}
                          onChange={(e) => setNuevoIngreso({ ...nuevoIngreso, precioUnitario: e.target.value })}
                        />
                      </div>
                    </>
                  )}
                    ...
                    <>
                      <div className="form-group">
                        ...
                        <input
                          ...
                          type="number"
                          min="0"
                          value={nuevoIngreso.litrosVendidos}
                          onChange={(e) => setNuevoIngreso({ ...nuevoIngreso, litrosVendidos: e.target.value })}
                        />
                      </div>
                      <div className="form-group">
                        <label>Precio Unitario (por litro)</label>
                        <input
                          className="input"
                          type="number"
                          min="0"
                      ...
                      <div className="form-group">
                        <label>Industria Compradora</label>
                        <input
                          className="input"
                          type="text"
                          placeholder="Ej. Dos Pinos, Coopeleche"
                          value={nuevoIngreso.industriaCompradora}
                          onChange={(e) => setNuevoIngreso({ ...nuevoIngreso, industriaCompradora: e.target.value })}
                        />
                      </div>
                    </>
                  )}
                    ...
                    <>
                      <div className="form-group">
                        ...
                        <input
                          className="input"
                          type="text"
                          placeholder="Ej. Venta de paja, alquiler de potrero"
                          value={nuevoIngreso.detalleOtros}
                          onChange={(e) => setNuevoIngreso({ ...nuevoIngreso, detalleOtros: e.target.value })}
                        />
                      </div>
                      <div className="form-group">
                  ...
                  <div className="form-group">
                    ...
                    <input
                      className="input"
                      type="text"
                      value={nuevoIngreso.compradorNombre}
                      onChange={(e) => setNuevoIngreso({ ...nuevoIngreso, compradorNombre: e.target.value })}
                    />
                  </div>
                  <div className="form-group">
                    <label>Comprador (Cédula)</label>
                    <input
                      className="input"
                      type="text"
                      value={nuevoIngreso.compradorCedula}
                      onChange={(e) => setNuevoIngreso({ ...nuevoIngreso, compradorCedula: e.target.value })}
                    />
                  </div>
                  <div className="form-group">
                    <label>Número Factura Electrónica Emitida</label>
                    <input
                      className="input"
                      type="text"
                      placeholder="Consecutivo o clave numérica"
                      value={nuevoIngreso.facturaNumero}
                      onChange={(e) => setNuevoIngreso({ ...nuevoIngreso, facturaNumero: e.target.value })}
                    />
                  </div>
                </div>
                <div style={{ marginTop: 'var(--espacio-md)' }}>
                  <button className="btn-primary" onClick={guardarIngreso}>
                    ...
                    <tbody>
                      {(ingresos.ingresos || []).map((ing) => (
                        <tr key={ing._id}>
                          ...
                          <td>
                            <span className={`badge badge-${ing.categoriaIngreso === 'venta_ganado_pie' ? 'primario' : ing.categoriaIngreso === 'venta_leche' ? 'exito' : 'secundario'}`}>
                              {CAT_INGRESO_LABEL[ing.categoriaIngreso]}
                            </span>
                          </td>
                      ...
                      {(ingresos.ingresos || []).length === 0 && (
                        <tr><td colSpan={8} className="tabla-vacia">No hay ingresos registrados en este periodo.</td></tr>
                      )}
                    </tbody>
                  </table>
                </div>
                ...
                <div className="declaracion-grid-3" style={{ marginTop: 'var(--espacio-md)' }}>
                  <div className="form-group">
                    ...
                    <input
                      className="input"
                      type="date"
                      value={nuevoGasto.fechaEmision}
                      onChange={(e) => setNuevoGasto({ ...nuevoGasto, fechaEmision: e.target.value })}
                    />
                  </div>
                  <div className="form-group">
                    ...
                    <input
                      className="input"
                      type="text"
                      value={nuevoGasto.emisorNombre}
                      onChange={(e) => setNuevoGasto({ ...nuevoGasto, emisorNombre: e.target.value })}
                    />
                  </div>
                  <div className="form-group">
                    <label>Categoría</label>
                    <select
                      className="input"
                      value={nuevoGasto.categoriaManual}
                      onChange={(e) => setNuevoGasto({ ...nuevoGasto, categoriaManual: e.target.value })}
                    >
                  ...
                  <div className="form-group">
                    ...
                    <input
                      className="input"
                      type="text"
                      placeholder="Ej. Concentrado 40kg, Vacuna brucelosis"
                  ...
                  <div className="form-group">
                    ...
                    <input
                      ...
                      type="number"
                      min="0"
                      value={nuevoGasto.totalVenta}
                      onChange={(e) => setNuevoGasto({ ...nuevoGasto, totalVenta: e.target.value })}
                    />
                  </div>
                  <div className="form-group">
                    ...
                    <input
                      ...
                      type="number"
                      min="0"
                      value={nuevoGasto.totalImpuesto}
                      onChange={(e) => setNuevoGasto({ ...nuevoGasto, totalImpuesto: e.target.value })}
                    />
                  </div>
                  <div className="form-group">
                    ...
                    <input
                      className="input"
                      type="text"
                      placeholder="Factura electrónica de compra"
                      value={nuevoGasto.numComprobante}
                      onChange={(e) => setNuevoGasto({ ...nuevoGasto, numComprobante: e.target.value })}
                    />
                  </div>
                </div>
                <div style={{ marginTop: 'var(--espacio-md)' }}>
                  <button className="btn-primary" onClick={guardarGastoManual}>
                    ...
                    <tbody>
                      {(gastos.gastos || []).map((g) => (
                        <tr key={g._id} className={g.esDeducible ? '' : 'fila-no-deducible'}>
                          ...
                          <td>{g.descripcion || (g.lineaDetalle?.map?.(l => l.descripcion).join('; ')) || '-'}</td>
                          ...
                          <td>
                            <button
                              className={`badge badge-${g.esDeducible ? 'exito' : 'error'} btn-badge`}
                              onClick={() => toggleDeducibilidad(g._id, g.esDeducible)}
                              title="Cambiar deducibilidad"
                            >
                      ...
                      {(gastos.gastos || []).length === 0 && (
                        <tr><td colSpan={9} className="tabla-vacia">No hay gastos registrados en este periodo.</td></tr>
                      )}
                    </tbody>
                  </table>
                </div>
            ...
            <div className="glass-card impuesto-resultado animate-slide-up">
              ...
              <div className="impuesto-grid" style={{ marginTop: 'var(--espacio-lg)' }}>
                <div className="impuesto-item">
                  ...
                  <span className="impuesto-valor text-mono text-success">{formatCRC(resumen.iva.ivaCobrado)}</span>
                </div>
                <div className="impuesto-item">
                  <span className="impuesto-label">IVA Pagado (Compras — Crédito Fiscal)</span>
                  <span className="impuesto-valor text-mono text-error">{formatCRC(resumen.iva.ivaPagado)}</span>
                </div>
                <div className="impuesto-item impuesto-item--resultado">
                  ...
                  <span className={`impuesto-valor-grande text-mono ${resumen.iva.aPagar ? 'text-error' : 'text-success'}`}>
                    {formatCRC(Math.abs(resumen.iva.ivaResultante))}
                  </span>
                </div>
              </div>
              ...
              {resumen.iva.detalleIVAPorTasa?.length > 0 && (
                <div className="impuesto-detalle">
                  ...
                  <table className="tabla">
                    <thead>
                      <tr><th>Tasa</th><th>Base Pagada (Compras)</th><th>IVA Pagado</th><th>Base Cobrada (Ventas)</th><th>IVA Cobrado</th></tr>
                    </thead>
                    <tbody>
                      {resumen.iva.detalleIVAPorTasa.map((d, i) => (
                        <tr key={i}>
                          <td>{d.tasa}%</td>
                          <td className="text-mono">{formatCRC(d.basePagada)}</td>
                          <td className="text-mono">{formatCRC(d.ivaPagado)}</td>
                          <td className="text-mono">{formatCRC(d.baseCobrada)}</td>
                          <td className="text-mono">{formatCRC(d.ivaCobrado)}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
              ...
              <div className="impuesto-grid" style={{ marginTop: 'var(--espacio-lg)' }}>
                <div className="impuesto-item">
                  <span className="impuesto-label">Facturas Procesadas</span>
                  <span className="impuesto-valor">{resumen.iva.totalFacturas}</span>
                </div>
                <div className="impuesto-item">
                  <span className="impuesto-label">Registros de Ingreso</span>
                  <span className="impuesto-valor">{resumen.iva.totalRegistrosIngresos}</span>
                </div>
              </div>
            </div>
          )}
          ...
          {tab === 'renta' && resumen?.renta && (
            <div className="glass-card impuesto-resultado animate-slide-up">
              ...
              <div className="impuesto-grid" style={{ marginTop: 'var(--espacio-lg)' }}>
                <div className="impuesto-item">
                  <span className="impuesto-label">Ingresos Brutos del Año</span>
                  <span className="impuesto-valor text-mono">{formatCRC(resumen.renta.ingresosBrutos)}</span>
                </div>
                <div className="impuesto-item">
                  <span className="impuesto-label">Gastos Brutos</span>
                  <span className="impuesto-valor text-mono text-error">{formatCRC(resumen.renta.gastosBrutos)}</span>
                </div>
                <div className="impuesto-item">
                  <span className="impuesto-label">Gastos Deducibles</span>
                  <span className="impuesto-valor text-mono text-success">{formatCRC(resumen.renta.gastosDeducibles)}</span>
                </div>
                <div className="impuesto-item">
                  <span className="impuesto-label">Utilidad Neta</span>
                  <span className="impuesto-valor text-mono" style={{ fontWeight: 700 }}>{formatCRC(resumen.renta.utilidadNeta)}</span>
                </div>
                <div className="impuesto-item">
                  <span className="impuesto-label">Monto Exento</span>
                  <span className="impuesto-valor text-mono">{formatCRC(resumen.renta.montoExento)}</span>
                </div>
                {resumen.renta.depreciacionTotal > 0 && (
                  <div className="impuesto-item">
                    <span className="impuesto-label">Depreciación de Activos</span>
                    <span className="impuesto-valor text-mono">{formatCRC(resumen.renta.depreciacionTotal)}</span>
                  </div>
                )}
              </div>
              ...
              {resumen.renta.detalleTramos?.length > 0 && (
                <div className="impuesto-detalle">
                  ...
                  <table className="tabla">
                    <thead>
                      <tr><th>Desde</th><th>Hasta</th><th>Tasa</th><th>Impuesto</th></tr>
                    </thead>
                    <tbody>
                      {resumen.renta.detalleTramos.map((t, i) => (
                        <tr key={i}>
                          <td className="text-mono">{formatCRC(t.desde)}</td>
                          <td className="text-mono">{formatCRC(t.hasta)}</td>
                          <td>{t.tasa}%</td>
                          <td className="text-mono">{formatCRC(t.impuesto)}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
              ...
              <div className="impuesto-grid" style={{ marginTop: 'var(--espacio-lg)' }}>
                <div className="impuesto-item">
                  <span className="impuesto-label">Créditos Fiscales</span>
                  <span className="impuesto-valor text-mono">{formatCRC(resumen.renta.creditosFiscales?.total)}</span>
                </div>
                <div className="impuesto-item impuesto-item--resultado">
                  <span className="impuesto-label">Impuesto Final a Pagar</span>
                  <span className={`impuesto-valor-grande text-mono ${resumen.renta.impuestoFinal > 0 ? 'text-error' : 'text-success'}`}>
                    {formatCRC(resumen.renta.impuestoFinal)}
                  </span>
          ...
          {tab === 'exportar' && (
            <div className="glass-card animate-slide-up">
              ...
              <div className="exportar-resumen">
                <div className="exportar-metrica">
                  <span className="exportar-label">Facturas registradas</span>
                  <span className="exportar-valor">{gastos.total || 0}</span>
                </div>
                <div className="exportar-metrica">
                  <span className="exportar-label">Ingresos registrados</span>
                  <span className="exportar-valor">{ingresos.total || 0}</span>
                </div>
                <div className="exportar-metrica">
                  <span className="exportar-label">Periodo</span>
                  <span className="exportar-valor">{anio} — {CUATRIMESTRE_LABEL[cuatrimestre]}</span>
                </div>
              </div>
              ...
              <div className="exportar-preview">
                ...
                <div className="exportar-columns">
                  {[
                    'Tipo', 'Fecha', 'Proveedor/Comprador', 'Cédula', 'Descripción', 'Categoría',
                    'Subtotal', 'IVA', 'Total', 'N° Comprobante', 'Es Deducible', 'Tasa IVA'
                  ].map((c) => (
